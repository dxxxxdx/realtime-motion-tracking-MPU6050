...
/**
 * @brief   PWM 16位周期配置，PWM1/2/3共用周期，PWM4/5共用周期
 *
 ...
 * @param   i       - 中断类型
 *                    RB_PWM_IE_CYC   - PWM1、2、3 周期结束中断使能位
 *                    RB_PWM1_IE_CYC  - PWM4、5 周期结束中断使能位
 *                    RB_PWM_IE_FIFO  - FIFO 数据小于 4 中断使能位
 *                    RB_PWM_IE_DMA   - DMA 传输结束中断使能位
 *                    RB_PWM_IE_OVER  - FIFO 读空中断使能位
 *
 * @return  none
 */
